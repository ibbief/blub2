...
import net.mcreator.mod.world.features.BiefuildingFeature;
...
public class ModModFeatures {
	...
	static {
		REGISTRY.put(BiefuildingFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.SURFACE_STRUCTURES,
				BiefuildingFeature.GENERATE_BIOMES, BiefuildingFeature.CONFIGURED_FEATURE));
	}
